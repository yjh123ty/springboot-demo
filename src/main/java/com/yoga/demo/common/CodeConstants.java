...
public class CodeConstants {
	...
	public final static byte ERROE_CODE_CONFIRM_MESSAGE = 8;//需confirm的消息code
	public final static byte ERROR_CODE_ILLEGAL_CODE = 9;//验证码输入错误
	public final static byte ERROR_CODE_ILLEGAL_LOGIN = 10;//登录验证错误
	public final static byte ERROR_CODE_ILLEGAL_REGISTER = 11;//注册验证错误
	public final static byte ERROR_CODE_FAIL_SEND_EMAIL = 11;//发送邮件错误
