...
//                    	
//                    } else if(response.data.results.length==0&&response.data.total!=0){
//                        that.reload(true);
//                    }
            ...
            // if(this.xqr.readyState.responseJSON.data.results==[]&&this.xqr.responseJSON.data.total!=0){
            //     that.reload(true);
            // }
        }
        else
     ...
     * @chainable
     **/
    Grid.prototype.reload = function(keepPages)
    {
        if(!keepPages) {
            this.current = 1;
        }
     ...
     * @author 周海刚
     */
    Grid.prototype.toPage = function(page)
    {
...
//                        .trigger("click" + namespace);
                	...
                	{
                		this.element.find("tbody > tr " + selectBoxSelector + ":checked").not("[value=\"" + id + "\"]")
                			.trigger("click" + namespace);
                	}
                }
